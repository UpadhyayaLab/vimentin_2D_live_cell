...
% DMSO
% base_dir_list{1}{1} = 'H:\FF\Vimentin_Data\Ciliobrevin_live\Cell DMSO\';
% 
% % ciliobrevin
...
% colors{1} = 'b'; % for plotting
% colors{2} = 'm';

condition_names_for_saving_figs{1} = 'PLL';
condition_names_for_saving_figs{2} = 'CD3';

% condition_names_for_saving_figs{1} = 'DMSO';
% condition_names_for_saving_figs{2} = 'Cilio';
